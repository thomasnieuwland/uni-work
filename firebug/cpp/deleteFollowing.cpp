 ...
 * Filename: deleteFollowing.cpp
 * Usage and implementation: this script allows a user to stop following a bug.
 *
 * POST inputs: bug_id
 */
...
g++ -std=c++11 -Wall -I/usr/include/cppconn -I/usr/include/json -o web/cgi-bin/deleteFollowing.cgi cpp/deleteFollowing.cpp -L/usr/lib -lmysqlcppconn -lcgicc
*/
...
int main(void)
{
	...
	try {
		...
		else
		{
			...
			prepStmt6 = conn->prepareStatement( "DELETE FROM following WHERE username=? AND bug_id=?" );
